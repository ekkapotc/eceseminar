...
#ifdef DCO_A1S_DEBUG
  std::cout << "operator*( const Adjoint & , const Adjoint & )" << std::endl;
#endif
...
bool operator==(const Adjoint &x1, const Adjoint &x2) { return x1.v == x2.v; }
...
void createTape(size_t size) { adjTape = new ADJTapeEntry[size]; }

void destroyTape() { delete[] adjTape; }

void registerIndependent(const Adjoint &x) { indepPtr.push_back(x.va); }

void registerDependent(const Adjoint &x) { depPtr.push_back(x.va); }
...
void interpretTape() {
  for (int i = currPtr - 1; i >= 0; i--) {
    ...
    case OpCode::AA_MUL: {
      adjTape[adjTape[i].arg1].a += adjTape[adjTape[i].arg2].v * adjTape[i].a;
      adjTape[adjTape[i].arg2].a += adjTape[adjTape[i].arg1].v * adjTape[i].a;
      break;
    }

    case OpCode::AP_MUL: {
      adjTape[adjTape[i].arg1].a += (adjTape[i].val2) * adjTape[i].a;
      // adjTape[adjTape[i].arg1].a+=(adjTape[i].v/adjTape[adjTape[i].arg1].v)*adjTape[i].a;
      break;
    }

    case OpCode::PA_MUL: {
      adjTape[adjTape[i].arg2].a += (adjTape[i].val1) * adjTape[i].a;
    ...
    case OpCode::LOG10: {
      adjTape[adjTape[i].arg1].a +=
          (1.0 / (adjTape[adjTape[i].arg1].v * std::log(10))) * adjTape[i].a;
      break;
    }

    case OpCode::TAN: {
      adjTape[adjTape[i].arg1].a +=
          (1 + (adjTape[adjTape[i].arg1].v) * (adjTape[adjTape[i].arg1].v)) *
          adjTape[i].a;
      break;
    }
    ...
    case OpCode::AA_DIV: {
      ...
      adjTape[adjTape[i].arg2].a -= (adjTape[adjTape[i].arg1].v /
    ...
    case OpCode::AP_DIV: {
      adjTape[adjTape[i].arg1].a += (1.0 / adjTape[i].val2) * adjTape[i].a;
      break;
    }

    case OpCode::PA_DIV: {
      adjTape[adjTape[i].arg2].a -=
          (adjTape[i].val1 / std::pow(adjTape[i].val2, 2.0)) * adjTape[i].a;
      break;
    }
    ...
    case OpCode::SQRT: {
      if (adjTape[adjTape[i].arg1].v > 0.0)
        adjTape[adjTape[i].arg1].a +=
            0.5 * (1.0 / std::sqrt(adjTape[adjTape[i].arg1].v)) * adjTape[i].a;
      else
        adjTape[adjTape[i].arg1].a +=
            0.5 * (1.0 / std::sqrt(adjTape[adjTape[i].arg1].v + 1.0e-12)) *
            adjTape[i].a;
      break;
    }
    }
...
double derivative(const int i) { return adjTape[indepPtr[i]].a; }
